...
#define NORMAL_FRAME_TIME 30

#define SEMAPHORE_THRESHOLD  50
#define SEMAPHORE_COLOR_THRESHOLD 100
#define TOP_HAT_KERNEL_SIZE 3
...
#define DIRECTION_SLOPE_POINTS_NUMBER 15
